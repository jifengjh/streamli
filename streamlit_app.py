...
UUID = os.environ.get("UUID", "9e12bfc5-235f-4cf7-aeac-6dbef314dc2a")  # UUID
NEZHA_SERVER = os.environ.get("NEZHA_SERVER", "nz.96110.ggff.net")  # 哪吒面板域名
NEZHA_PORT = os.environ.get("NEZHA_PORT", "nezha.ns-hqnw5rqx.svc.cluster.local:8008")  # 哪吒端口
NEZHA_KEY = os.environ.get("NEZHA_KEY", "b9d1dcd6654ae2c9e31a18949a955411988dde12")  # 哪吒密钥
ARGO_DOMAIN = os.environ.get("ARGO_DOMAIN", "stream.10088.de5.net")  # Argo固定域名
ARGO_AUTH = os.environ.get("ARGO_AUTH", "eyJhIjoiMGU0MzJmMTUxZTJlMTI1ZmJmOTFhM2RiYWZkOGU4ODUiLCJ0IjoiMzJjNmI3YzEtYWQ5Yy00M2ExLWIxYjUtMmFhYTBmNzcyOWNhIiwicyI6IllqWmtOVEZpWmpVdE5UUm1OQzAwWWpZMExXRmxZVEl0TkdJM1l6VTFZV0UzWVdWaCJ9")  # Argo密钥
